...
unless ActiveRecord::Base.include?(IgnoreColumns::InstanceMethods)
  ActiveRecord::Base.send :include, IgnoreColumns::InstanceMethods
  ActiveRecord::Base.send :extend, IgnoreColumns::ClassMethods
end
